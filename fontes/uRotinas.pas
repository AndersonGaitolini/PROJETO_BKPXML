...
function pCompressLote(var pStream: TStream);
...
begin
  ...
  wSaveXML.Filter := 'ZIP|*.zip';
  wSaveXML.Title :=  'Salve o arquivo ZIP ';
  wSaveXML.InitialDir := ExtractFileDir(GetCurrentDir);
  wSaveXML.FileName := 'Notas.zip';
